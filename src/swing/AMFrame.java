...
//				if(addCourse(String schoolID, String code, String name, int creditHours, String desc,
//						ArrayList<Course> preReqs) == null)
//				{
//					//prompt
//				}
			}
		...
		comboBox_9.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				...
				//fillCourseSections(comboBox_5, comboBox_9.getSelectedIndex(), comboBox_14.getSelectedIndex());
...
//				if (Session.getUser().updateFaculty(schoolID, name, "password", dob, phone, email, cnic, gender,
...
//					textField_59.setText(staff.getPosition());
		...
		button_4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
			    ...
			    //Date dateHired = datePicker.getDate..
			    String empID = textField_6.getText();
//				if (Session.getUser().registerFaculty(schoolID, name, "password", dob, phone, email, cnic, gender,
//					emer, address, Date dateHired, degrees,
//					position, empID) == null)
			    {
			    	//error prompt
		...
		comboBox_22.setBounds(471, 329, 154, 20);
		...
		button_18.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//Course course = Session.getSchool().getCourse(c_code);
				//if (course != null)
				...
				dtm.addRow(new Object[] { "LOL", "LOL", "LOL"});
				//dtm.addRow(new Object[] { course.getName(), course.getCourseCode()});
		...
		button_19.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//FacultyMember fac = Session.getInst().getFaculty(textField_55.getText());
				//if (fac != null)
				//{
				...
				dtm2.addRow(new Object[] { "LOL", "LOL", "LOL"});
				...
				btnRemove.addMouseListener(new MouseAdapter() {
					@Override
					public void mouseClicked(MouseEvent e) {
						//Session.getUser().removeFaculty((String) dtm.getValueAt(0, 0) , (String) dtm2.getValueAt(0, 0));
		...
		btnAddSchool.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//if (Session.getUser().addSchool(schoolID, name) == false)
//				{
//					//error prompt
//				}
			}
		...
		comboBox_11.setBounds(191, 106, 154, 20);
		...
		button_6.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//Date date = datepicker.getDate..button_5.
				...
				//String schoolID = 
//				if (Session.getUser().registerStudent(schoolID, name, date, String phone,
//			    	email, cnic, gender, emer, address, fCNIC, String fName) !=null)
//				else
//				{
//					//error prompt
//				}
		...
		lblManageFaculty.setBounds(57, 89, 182, 27);
		...
		lblManageStudents.setBounds(57, 141, 182, 27);
		...
		lblManageSections.setBounds(57, 195, 182, 22);
		...
		label_3.setBounds(12, 247, 40, 32);
		...
		label_2.setBounds(12, 195, 33, 27);
		...
		lblManageSchools.setBounds(57, 303, 182, 22);
		...
		label_89.setBounds(12, 303, 33, 27);
...
//	{
//		School school = Session.inst.getSchools().get(index);
//		ArrayList<Course> courses = school.getCurrentSemesterCourses();
...
//	{
//		School school = Session.inst.getSchools().get(index1);
//		ArrayList<CourseSection> sections = school.getCurrentSemesterCourses.get(i).get
//		for (int i = 0; i < courses.size(); i++)
//		{
//			courses.get(i).getCourseSections
//		}
//	}
...
//	public void fillPreReqs()
//	{
//		ArrayList<Course> courses = Session.school.getCourses();
//		for (int i = 0; i < courses.size(); i++)
//		{
